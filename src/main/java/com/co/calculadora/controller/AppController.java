...
public class AppController {
	...
	public String getOperatinAction(HttpServletRequest request, HttpServletResponse reponse, Model model,
		...
		case "SUMA":
			response = sendGET("http://127.0.0.1:5000/suma/" + formObject.getNum1Action() + "/" + formObject.getNum2Action());
			break;
		case "RESTA":
			response = sendGET("http://127.0.0.1:5000/resta/" + formObject.getNum1Action() + "/" + formObject.getNum2Action());
			break;
		case "MULTIPLICA":
			response = sendGET("http://127.0.0.1:5000/multiplicacion/" + formObject.getNum1Action() + "/" + formObject.getNum2Action());
			break;
		case "DIVIDE":
			response = sendGET("http://127.0.0.1:5000/division/" + formObject.getNum1Action() + "/" + formObject.getNum2Action());
			break;
		default:
			break;
		}
